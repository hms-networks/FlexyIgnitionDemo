...
public class FlexyDemoTagManager
{
    ...
    * If unable to get value, Integer.MIN_VALUE is returned
    *
    ...
    * If unable to get value, false is returned
    *
    * @param tagName Name of Tag
    *
    * @return Value of Tag with tagName
    ...
    * If unable to get value, Double.MIN_VALUE is returned
    *
    * @param tagName Name of Tag
    *
    * @return Value of Tag with tagName
   ...
   public static void setTagAsInt( String tagName, int newValue )
   {
      try {
         ...
         System.out.println( "[FlexyDemo] An error occurred while setting tag " + tagName + " as an Integer. Ensure " +
   ...
   public static void setTagAsBoolean( String tagName, boolean newValue )
   {
      try {
         ...
         System.out.println( "[FlexyDemo] An error occurred while setting tag " + tagName + " as a Boolean. Ensure " +
   ...
   public static void setTagAsDouble( String tagName, double newValue )
   {
      try {
         ...
         System.out.println( "[FlexyDemo] An error occurred while setting tag " + tagName + " as a Double. Ensure " +
   ...
   static void uploadTagConfig( ArrayList scenarios )
   {
      ...
      try {
         ...
         if ( !FTPReply.isPositiveCompletion( ftpClient.getReplyCode() ) ) {
            ...
            System.out.println( "[FlexyDemo] FTP automatic tag configuration has encountered an error creating a " +
         ...
         System.out.println( "[FlexyDemo] FTP automatic tag configuration has encountered an error. Please ensure " +

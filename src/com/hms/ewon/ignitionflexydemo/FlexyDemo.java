...
public class FlexyDemo
{
   ...
   private static void runDemo()
   {
      ...
      while ( isRunning ) {
         ...
         try {
            ...
            System.out.println( "[FlexyDemo] An error occurred while updating the current running demo scenario. Demo" +
   ...
   {
      if (flexyDemoScenarios.size() == 0) System.out.println( "[FlexyDemo] No scenarios configured during Tag Config " +
                                                              "Upload");

...
public class FlexyDemoTagConfig
{
    ...
    */
   public FlexyDemoTagConfig( String tagName, int tagType, double tagLowLow, double tagLow, double tagHigh,
   ...
   String getTagAsJSON()
   {
      ...
      return FlexyDemoTagManager.getNewTagID() + ";\"" + tagName + "\";\"\";\"MEM\";\"\";\"" + tagName +
             "\";1.000000;0" + ".000000;0;" + tagAlarmInt + ";0;1;0;0;0;0;0;0;1;0;\"\";" + tagHigh + ";" + tagLow +
             ";0;" + tagDeadband + ";0;0;0;0;1;" + "600;10;-1.000000;0;" + tagLowLow + ";" + tagHighHigh +
             ";1;1.000000;0.000000;;\"\";\"\";\"\";" + "\"\";;;\"\";\"\";;\"\";;\"\";\"\";0;" + tagType + ";2;\"" +
             dateTime + "\";0;65472;5\r\n";
   }

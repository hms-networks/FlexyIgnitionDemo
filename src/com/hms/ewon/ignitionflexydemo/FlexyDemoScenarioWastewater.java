...
public class FlexyDemoScenarioWastewater extends FlexyDemoScenario
{
   ...
   /**
    * Perform initial generation and setup of this <code>FlexyDemoScenario</code> Note: This scenario generation code is
    * following the same order of devices as the order of the process
    */
   protected void genScenario()
   {
      // Lift Stations
      String[] liftStation_names = { "LiftStation-A01", "LiftStation-A02", "LiftStation-B01", "LiftStation-B02" };
      ...
      for ( int i = 0; i < liftStation_names.length; i++ ) {
         devices.add( new FlexyDemoLiftStation( liftStation_names[ i ], liftStation_flowLowGPM, liftStation_flowHighGPM,
                                                liftStation_flowIdealGPM, FlexyDemoFlexy.PWR_ON ) );
      }

      // Bar Screens
      String[] barScreen_names =
            { "BarScreen-A01", "BarScreen-A02", "BarScreen-A03", "BarScreen-A04", "BarScreen-B01", "BarScreen-B02",
      ...
      for ( int i = 0; i < barScreen_names.length; i++ ) {
         devices.add( new FlexyDemoBarScreen( barScreen_names[ i ], barScreen_flowLowGPM, barScreen_flowHighGPM,
                                              barScreen_flowIdealGPM ) );
      }

      // Grit Remover
      String[] gritRemover_names =
            { "GritRemover-A01", "GritRemover-A02", "GritRemover-A03", "GritRemover-A04", "GritRemover-B01",
      ...
      for ( int i = 0; i < gritRemover_names.length; i++ ) {
         devices.add( new FlexyDemoGritRemover( gritRemover_names[ i ], gritRemover_flowLowGPM, gritRemover_flowHighGPM,
      ...
      String[] settleTankPrimary_names =
            { "SettleTankPrimary-A01", "SettleTankPrimary-A02", "SettleTankPrimary-A03", "SettleTankPrimary-A04",
              "SettleTankPrimary-B01", "SettleTankPrimary-B02", "SettleTankPrimary-B03", "SettleTankPrimary-B04" };
      ...
      for ( int i = 0; i < settleTankPrimary_names.length; i++ ) {
         devices.add( new FlexyDemoSettlingDrainTank( settleTankPrimary_names[ i ], settleTankPrimary_fillLowPerc[ i ],
      ...
      for ( int i = 0; i < sludgeDigester_names.length; i++ ) {
         devices.add( new FlexyDemoSludgeDigester( sludgeDigester_names[ i ], sludgeDigester_fillLowPerc[ i ],
      ...
      String[] aerationTank_names =
            { "AerationTank-A01", "AerationTank-A02", "AerationTank-A03", "AerationTank-A04", "AerationTank-B01",
      ...
      for ( int i = 0; i < settleTankSecondary_names.length; i++ ) {
         devices.add( new FlexyDemoSettlingTank( settleTankSecondary_names[ i ], settleTankSecondary_fillLowPerc[ i ],
      ...
      String[] chlorinatorValve_names =
            { "ValveChlorinator-A01", "ValveChlorinator-A02", "ValveChlorinator-A03", "ValveChlorinator-A04",
              "ValveChlorinator-B01", "ValveChlorinator-B02", "ValveChlorinator-B03", "ValveChlorinator-B04" };
      ...
      String[] chlorinator_names =
            { "Chlorinator-A01", "Chlorinator-A02", "Chlorinator-A03", "Chlorinator-A04", "Chlorinator-B01",
      ...
      String[] pHSensor_names =
            { "PHSensor-A01", "PHSensor-A02", "PHSensor-A03", "PHSensor-A04", "PHSensor-B01", "PHSensor-B02",
      ...
      for ( int i = 0; i < egressPump_names.length; i++ ) {
         devices.add( new FlexyDemoPump( egressPump_names[ i ], egressPump_flowLowGPM[ i ], egressPump_flowHighGPM[ i ],

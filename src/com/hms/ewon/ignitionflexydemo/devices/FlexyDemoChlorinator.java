...
public class FlexyDemoChlorinator extends FlexyDemoFlexy {
  ...
  /**
   * Basic <code>FlexyDemoChlorinator</code> constructor. Create and initialize a settling tank with
   ...
   */
  public FlexyDemoChlorinator(String name, int fillLowPerc, int fillHighPerc, int fillIdealPerc,
      boolean drainOpen) {
    super(name);
  ...
  protected void initTagConfigs() {
    addTagConfig(
        new FlexyDemoTagConfig(getTagFullName("DRAINOPEN"), FlexyDemoTagConfig.TYPE_BOOLEAN));

...
public class FlexyDemoAerationTank extends FlexyDemoFlexy
{
   ...
   /**
    * Basic <code>FlexyDemoAerationTank</code> constructor. Create and initialize a basic air compressor with simulated
    * data.
    *
   ...
   protected void runCycleUpdate()
   {
      try {
         if ( getTagValueAsLong( "PWR" ) == PWR_ON ) {
            ...
            setTag( "BOD", new Integer(
                  FlexyDemo.randomIntHighWeight( bioOxygenDemandLow, bioOxygenDemandHigh, bioOxygenDemandIdeal ) ) );
            setTag( "DISSOLVEDO2", new Integer(
                  FlexyDemo.randomIntHighWeight( dissolvedOxygenLow, dissolvedOxygenHigh, dissolvedOxygenIdeal ) ) );

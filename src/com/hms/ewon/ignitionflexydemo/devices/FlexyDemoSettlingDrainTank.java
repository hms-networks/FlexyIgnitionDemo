...
public class FlexyDemoSettlingDrainTank extends FlexyDemoFlexy {
  ...
  /**
   * Basic <code>FlexyDemoSettlingDrainTank</code> constructor. Create and initialize a settling
   * tank with drain with simulated data for fill.
   *
   ...
   */
  public FlexyDemoSettlingDrainTank(String name, int fillLowPerc, int fillHighPerc,
      int fillIdealPerc,
      int drainOpenPerc) {
    super(name);
  ...
  protected void initTagConfigs() {
    addTagConfig(
        new FlexyDemoTagConfig(getTagFullName("DRAINOPENPERC"), FlexyDemoTagConfig.TYPE_INTEGER));

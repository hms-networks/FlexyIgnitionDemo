...
public class FlexyDemoSludgePress extends FlexyDemoFlexy
{
   ...
   /**
    * Basic <code>FlexyDemoSludgePress</code> constructor. Create and initialize a basic press to squeeze liquid out of
    * sludge.
    *
    ...
    */
   public FlexyDemoSludgePress( String name, int motorLowRPM, int motorHighRPM, int motorIdealRPM, int initPowerStatus )
   {
      super( name );
   ...
   protected void initTags()
   {
      ...
      for ( int x = 1; x <= NUM_MOTORS; x++ ) { setTag( "MOTOR" + x + "-RPM", new Integer( PWR_ON ) ); }
